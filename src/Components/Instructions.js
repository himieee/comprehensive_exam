    ...
    <div className="w-full min-h-screen flex bg-[#FCFAEE]">
      <div className="w-11/12 h-4/5 mx-auto mt-2 flex flex-col p-2">
        ...
        <ul className="list-disc mx-4 mt-2">
          <li>
            The comprehensive exam consists of 100 multiple-choice questions
            (MCQs).
          </li>
          <li>
          ...
          <li>
            The exam duration is <u>2 hours.</u>
          </li>
        </ul>
        ...
        <ul className="list-disc mx-4 mt-2">
          <li>
            ...
            <u>completed at least 65% of the total credits</u> as per their
            curriculum are eligible to appear for the exam.
          </li>
        </ul>
        ...
        <ul className="list-disc mx-4 mt-2">
          <li>
            <u>No registration fees</u> for students appearing for the first
            time.
          </li>
          ...
          <ul className="list-disc mx-8">
            ...
            <li>
              Students who registered previously but did not attend the exam.
            </li>
          </ul>
        </ul>
